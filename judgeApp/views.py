...
def get_signals_dict():
    signals = {
        ...
        159: 'A.T',  # 31 SIGSYS (When system call doent match)
        135: 'A.T',  # Bus error 7 int x[10000000000000]

        136: 'R.T.E',  # SIGFPE sig -> 8 floating point exception
        139: 'R.T.E',  # (128 + 11) -> 11 SIGSEGV (Invalid memory reference)

        137: 'T.L.E',  # SIGKILL 9  (Time limit exceeded or resource voilation killed by setprlimit)
